...
export type GameCreationAction =
  ...
  | { type: 'UPLOAD_IMAGE_SUCCESS'; payload: { questionId: string; imageUrl: string } }
  | { type: 'UPLOAD_IMAGE_ERROR'; payload: { questionId: string; error: string } }
  | { type: 'SET_IMAGE_HOVER'; payload: { questionId: string; isHovered: boolean } }
...
export const gameCreationActions = {
  ...
  updateQuestion: (id: string, updates: Partial<Question>): GameCreationAction => ({
  ...
  uploadImageSuccess: (questionId: string, imageUrl: string): GameCreationAction => ({
    type: 'UPLOAD_IMAGE_SUCCESS',
    payload: { questionId, imageUrl }
  }),

  uploadImageError: (questionId: string, error: string): GameCreationAction => ({
    type: 'UPLOAD_IMAGE_ERROR',
    payload: { questionId, error }
  }),

  setImageHover: (questionId: string, isHovered: boolean): GameCreationAction => ({

...
export interface GameShareResponse extends ApiResponse<null> {}

export const shareGame = async (gameId: UUID): Promise<GameShareResponse> => {
...
export const unshareGame = async (gameId: UUID): Promise<GameShareResponse> => {
